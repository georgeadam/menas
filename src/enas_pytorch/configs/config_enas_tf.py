...
def add_arguments(net_arg, data_arg, learn_arg, misc_arg):
    ...
    net_arg.add_argument('--shared_dropoute', type=float, default=0.25)  # TODO
    net_arg.add_argument('--shared_dropouti', type=float, default=0.75)  # TODO
    net_arg.add_argument('--shared_embed', type=int, default=720)  # TODO: 200, 500, 1000
    net_arg.add_argument('--shared_hid', type=int, default=720)
    ...
    learn_arg.add_argument('--test_batch_size', type=int, default=20)
    ...
    learn_arg.add_argument('--controller_lr', type=float, default=0.001,
    ...
    learn_arg.add_argument('--shared_lr', type=float, default=0.25)
    learn_arg.add_argument('--shared_decay', type=float, default=0.95)
    ...
    learn_arg.add_argument('--shared_grad_clip', type=float, default=10.0)
    ...
    misc_arg.add_argument('--max_save_num', type=int, default=1)
