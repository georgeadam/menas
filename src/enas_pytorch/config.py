...
learn_arg.add_argument('--shared_max_step', type=int, default=4,
...
misc_arg.add_argument('--log_step', type=int, default=4)
misc_arg.add_argument('--save_epoch', type=int, default=1000)
