...
from hardcoded_networks.hardcoded_generator import HardcodedArchitectureGenerator
...
class HardcodedTrainer(object):
    ...
    def build_model(self):
        ...
        self.generator = HardcodedArchitectureGenerator(self.args)
