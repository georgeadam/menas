...
from regularized_controllers.tied_weights import TiedWeightsController

from train_scripts.regular_trainer import Trainer, _get_optimizer

logger = utils.get_logger()

class TiedWeightsTrainer(Trainer):
    ...
    def build_model(self):
        ...
        self.controller = TiedWeightsController(self.args)
